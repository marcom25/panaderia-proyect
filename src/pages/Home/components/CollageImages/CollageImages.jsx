...
const CollageImages = () => {
    ...
    return (  
        <>   
            <div className="col-md-4 col-12 p-3 p-md-2 wow fadeIn zoom" data-wow-delay= '1s' data-wow-duration="1s" >
            ...
            <div className="col-md-4 col-12 p-3 p-md-2 wow fadeIn zoom" data-wow-delay= '1.1s' data-wow-duration="1s">
            ...
            <div className="col-md-4 col-12 p-3 p-md-2 wow fadeIn zoom" data-wow-delay= '1.2s' data-wow-duration="1s">
