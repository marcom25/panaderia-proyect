              ...
              <div className="collapse navbar-collapse mecanismomenu" id="navbarNavDropdown">
                <ul className="navbar-nav d-flex justify-content-around m-auto">
                  <li className="nav-item w-20 my-auto text-center">
                    <a className="nav-link brown-font productOptions" aria-current="page" href="#">Inicio</a>
                  </li>
                  <li className="nav-item w-20 my-auto text-center">
                    <a className="nav-link brown-font productOptions" href="#">Productos</a>
                  </li>
                  ...
                  <li className="nav-item my-auto w-20 text-center">
                    <a className="nav-link brown-font productOptions" href="#">Nosotros</a>
                  </li>
                  <li className="nav-item my-auto w-20 text-center">
                    <a className="nav-link brown-font productOptions" href="#">Contactanos</a>
                  </li>
                </ul>
              </div>
