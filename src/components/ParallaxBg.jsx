...
const ParallaxBg = () => {
    ...
    return (
        ...
        > 
            ...
            <p className='texto text-center paragraph font-satisfy text-wrap pt-5 mt-2 d-none d-sm-block wow fadeIn' data-wow-delay= '4s' data-wow-duration="2s">No te quedes con las ganas..</p>
            <div className='sizer' />
        </Parallax>
    );
};
