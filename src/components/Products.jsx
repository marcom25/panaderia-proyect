        ...
        <>
            ...
            <section className='container-xs bg-cream pt-2 pb-5'>
                ...
                <div className='d-flex'>
                    <div className='d-none d-md-block ps-4 pe-5' style={{width: 'max-content'}}>
                        ...
                        <div className='filters'>
                            ...
                            <ul className='list-unstyled line-height-products mb-3'>
                                <input type="radio" className="d-none" name="categories" id="Brownies" value='Brownies' />
                                <input type="radio" className="d-none" name="categories" id="Tortas" value='Tortas'/>
                    ...
                    <div className='d-flex flex-wrap posts pe-lg-4 pe-xl-5'>
                        <div className='cardsWidth p-2 py-3 py-lg-3 bg-cream post' data-category={"Brownies"}>
                        ...
                        <div className='cardsWidth p-2 py-3 py-lg-3 bg-cream post' data-category={"Tortas"}>
                            <div class="card bg-cream w-100 border-0">
                                <img src={image1} class="card-img-top w-100 imgWidth" alt="..." />
                                <div className='capaPadre'>
                                    <div>
                        ...
                        <div className='cardsWidth p-2 py-3 py-lg-3 bg-cream post' data-category={"Masitas"}>
                            <div class="card bg-cream w-100 border-0">
                                <img src={image1} class="card-img-top w-100 imgWidth" alt="..." />
                                <div className='capaPadre'>
                                    <div>
                        ...
                        <div className='cardsWidth p-2 py-3 py-lg-3 bg-cream post' data-category={"Tartas"}>
                            <div class="card bg-cream w-100 border-0">
                                <img src={image1} class="card-img-top w-100 imgWidth" alt="..." />
                                <div className='capaPadre'>
                                    <div>
                        ...
                        <div className='cardsWidth p-2 py-3 py-lg-3 bg-cream post' data-category={"Macaroons"}>
                            <div class="card bg-cream w-100 border-0">
                                <img src={image1} class="card-img-top w-100 imgWidth" alt="..." />
                                <div className='capaPadre'>
                                    <div>
                        ...
                        <div className='cardsWidth p-2 py-3 py-lg-3 bg-cream post' data-category={"Muffins"}>
                            <div class="card bg-cream w-100 border-0">
                                <img src={image1} class="card-img-top w-100 imgWidth" alt="..." />
                                <div className='capaPadre'>
                                    <div>
                        ...
                        <div className='cardsWidth p-2 py-3 py-lg-3 bg-cream post' data-category={"Budines"}>
                            <div class="card bg-cream w-100 border-0">
                                <img src={image1} class="card-img-top w-100 imgWidth" alt="..." />
                                <div className='capaPadre'>
                                    <div>
                        ...
                        <div className='cardsWidth p-2 py-3 py-lg-3 bg-cream post' data-category={"Cheesecakes"}>
                            <div class="card bg-cream w-100 border-0">
                                <img src={image1} class="card-img-top w-100 imgWidth" alt="..." />
                                <div className='capaPadre'>
                                    <div>
                        ...
                        <div className='cardsWidth p-2 py-3 py-lg-3 bg-cream post' data-category={"Café"}>
                            <div class="card bg-cream w-100 border-0">
                                <img src={image1} class="card-img-top w-100 imgWidth" alt="..." />
                                <div className='capaPadre'>
                                    <div>
                        ...
                        <div className='cardsWidth p-2 py-3 py-lg-3 bg-cream post' data-category={"Té"}>
                            <div class="card bg-cream w-100 border-0">
                                <img src={image1} class="card-img-top w-100 imgWidth" alt="..." />
                                <div className='capaPadre'>
                                    <div>
                        ...
                        <div className='cardsWidth p-2 py-3 py-lg-3 bg-cream post' data-category={"Chocolatada"}>
                            <div class="card bg-cream w-100 border-0">
                                <img src={image1} class="card-img-top w-100 imgWidth" alt="..." />
                                <div className='capaPadre'>
                                    <div>
