...
const Sidebar = () => {
  return (
    <>
      <nav className="navbar navbar-light bg-pink sticky-top d-lg-none">
          ...
          <div  className="offcanvas offcanvas-start bg-pink" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel" style={{width: 'max-content'}}>
            ...
            <div className="offcanvas-body p-0">
              <ul className="navbar-nav justify-content-end flex-grow-1 brown-font">
                ...
                <li className="nav-item bg-brown-hover">
                  <a className="nav-link d-flex align-items-center brown-font font-pink-hover px-3" href="#"><FaStore style={{fontSize: '1.5rem', paddingRight: '5px'}}/> Productos</a>
                </li>
                <li className="nav-item bg-brown-hover">
                ...
                <li className="nav-item bg-brown-hover">
                  <a className="nav-link d-flex align-items-center brown-font font-pink-hover px-3" href="#"><SiGooglemessages style={{fontSize: '1.5rem', paddingRight: '5px'}}/> Contactanos</a>
                </li>
              </ul>
            </div>
          </div>
