...
export const CartPage = () => {
  ...
  useEffect(() => {
    ...
    setTotal(cart.reduce((acc, curr) => acc + Number(curr.price) * curr.qty + Number(curr.price) * curr.qty * .21, 0));
  }, [cart]);
                    ...
                    <div className="row">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-4">
                                        ...
                                        <div className="d-flex">
                                            ...
                                            <div className="ps-3">
                                                <select class="form-select" aria-label="Default select example" onChange={(e) => dispatch({type: "CHANGE_CART_QTY", payload: {id: prod.id, qty: e.target.value,},})}>
                                    ...
                                    <div className="col-4 col-md-3 text-end ms-md-2">
                                        <button className="deleteIcon bg-cream fs-4" onClick={() => dispatch({type:"REMOVE_FROM_CART", payload: prod,})}><AiFillDelete className="deleteIcon brown-font"/></button>
                                    </div>
                                </div>
                                <hr className="w-100" />
                            </div>
                        ...
                        <div className="col-12 col-lg-8 text-start p-0 d-lg-none px-3">
                            ...
                            <div className="m-auto">
                                <div className="w-100">
                                    <button className="w-100 fs-5 buttons bg-brown white-font py-1" disabled={cart.length === 0}>Pagar</button>
                                </div>
                            </div>
                        </div>
