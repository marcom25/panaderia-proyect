    ...
    <>
        <section className="container-xs bg-cream pt-2 pb-5 ">
                    ...
                    <div className="col-12 py-0 px-3 d-none d-lg-block">
                        ...
                        <div className="m-auto">
                            <div className="w-100 p-3">
                                <button className="w-100 fs-5 returnButton font-poppins buttonPay" disabled={cart.length === 0}>Pagar</button>
                            </div>
                        </div>
                    </div>
                </div> 
            ...
            <div className="text-center py-5">
                ...
                <Link to="/productos">
                    <button className="font-poppins returnButton">Volver a productos</button>
                </Link>
            </div>
        </section>
    </>
